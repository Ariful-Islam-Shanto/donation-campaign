  ...
  return (
    ...
    <div className=" h-[60vh] md:h-[100vh] lg:h-[60vh] xl:h-[600px] flex items-center justify-center">
      <div className=" space-y-6 md:space-y-12  mt-16 md:mt-0 lg:mt-32 xl:mt-0">
        <h1 className="text-3xl md:text-3xl lg:tex-4xl xl:text-6xl text-center text-black font-bold ">
        ...
        <div className="flex justify-center items-center">
          <input
            ...
            className="px-4 md:px-4 lg:px-4 py-3 md:py-2 lg:py-2 xl:px-6 xl:py-4 text-xs md:text-sm lg:text-sm xl:text-xl rounded-lg border shadow-none placeholder-gray-400 outline-0 md:w-[350px] lg:w-[350px] xl:w-[450px]"
          />
